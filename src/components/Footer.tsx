...
export default function Footer() {
  ...
  return (
    <footer 
      ref={footerRef}
      className="bg-[#0C0E21] border-t border-white/5"
    >
        ...
        <div className={`transition-all duration-1000 ease-out ${
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 mb-8">
            ...
            <div className="flex flex-col items-start space-y-4">
              ...
              <p className="font-lato text-white/60 text-sm max-w-xs">
                AI-powered bidding for Web3 launches. The future of decentralized project launches.
              </p>
            </div>

            {/* Navigation Menu */}
            <div className="flex flex-col items-start space-y-4">
              <h3 className="font-titillium text-lg font-semibold text-white">Navigation</h3>
              <nav className="flex flex-col space-y-2">
                {navItems.map((item) => (
                  <button 
                    key={item.id}
                    onClick={() => scrollToSection(item.id)}
                    className="text-white/60 hover:text-white transition-colors duration-300 font-lato text-sm text-left"
                  >
                    {item.label}
                  </button>
                ))}
            ...
            {/* Social Links */}
            <div className="flex flex-col items-start space-y-4">
              <h3 className="font-titillium text-lg font-semibold text-white">Connect</h3>
          ...
          <div className="pt-8 border-t border-white/10">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              <p className="font-lato text-white/40 text-sm">
                © 2025 bid.launch. All rights reserved.
              </p>
